    ...
    div.innerHTML = `
        ...
        <div class="details-bottom">
          ...
          ${movie.budget 
            ...
            :
            `<li><span class="text-secondary">Budget:</span> Undisclosed </li> `
          }
          ${movie.revenue 
            ?
            `<li><span class="text-secondary">Revenue:</span>$${addCommasToNumber(movie.revenue)}</li>`
            :
            `<li><span class="text-secondary">Revenue:</span> Undisclosed </li>`
          }
...
async function fetchAPIData(endpoint){
    // only used for development or very small projects, with free API from themoviedb
    const API_KEY = 'ea563747f84d90bc06099ebc628f041d';
